...
public class PlayerData {
	...
	public PlayerData(Vec2 pos, String flip, String name, float maxhp, float maxmana, Vec2 size, int[] maxSkillCD, int DCD) {
	...
	private PlayerData() {
		this(new Vec2(), "right", "dummy", 10, 10, new Vec2(), new int[0], 10); //$NON-NLS-1$ //$NON-NLS-2$
	}
