...
public class TextBlood extends TextEffect {
	
	public TextBlood(String text, Vec2 pos, int time, int MAX_TIME) {
		super(text, pos, time, MAX_TIME, GameFont.Blood);
	}
	public TextBlood(String text, Vec2 pos, int time) {
		this(text, pos, time, 300);
	}
	public TextBlood(String text, Vec2 pos) {
		this(text, pos, 300);
	}
	...
	public void update() {
		...
		getPos().addX(GameMath.nextInt(-15, 20) * Gdx.graphics.getDeltaTime());
	}
}
