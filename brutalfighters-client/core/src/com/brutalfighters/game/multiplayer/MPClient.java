...
public class MPClient {
	...
	public MPClient() {
		...
		client.start();
		try {
			//client.connect(5000, "188.226.195.78", 54777, 54666); // OLD_OUTDATED_DIGITALOCEAN_EU
			//client.connect(5000, "107.170.243.67", 54777, 54666); // NA_SanFrancisco_DigitalOcean
